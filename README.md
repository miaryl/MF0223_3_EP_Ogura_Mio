...
- Esté limpia (sin archivos innecesarios)
- Tenga una estructura clara

4. Crear un repositorio en GitHub (o GitLab)
5. Crear un ***readme.md***
6. Subir el proyecto completo al repositorio
   ...
   git branch -M main
   git remote add origin https://github.com/miaryl/MF0223_3_EP_Ogura_Mio.git
